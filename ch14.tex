...
But that won't work, because \java{name}, \java{price}, and \java{sku} are \java{private}.  We can't call the setter methods for \java{name} and \java{sku} because there aren't any. What we need to do is call the superclass constructor, which {\em can} set those attributes.  To call a superclass constructor, you use the keyword \java{super}:
