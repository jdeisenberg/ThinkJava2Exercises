...
\subsection{The \java{City} class}
...
\subsection{The \java{CityInfo} class}

Then, write a class named \java{CityInfo} that contains the \java{main()} method.Use the {\em citylist.dat} file to set up the initial list of cities. The file is available from the repository at {\em ch18/citylist.dat} Each line of the text file has a country code, city name, and population, separated by semicolons. Your program must first read the city data file with this method:
...
\subsection*{The \java{Account} class}
...
\subsection*{The \java{Customer} class}
