...
where $s_x$ and $s_y$ are the standard deviations of the two arrays. You can use the \java{stdev} method that you wrote in Exercise~\ref{ex:standardize} for those calculations.
